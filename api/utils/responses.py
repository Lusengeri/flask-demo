...
INVALID_INPUT_422 = {"http_code": 422, "code": "invalidInput", "message": "Invalid input"}
...
UNAUTHORIZED_401 = {"http_code": 401, "code": "loginFail", "message": "Wrong email password combination"}
...
SERVER_ERROR_500 = {"http_code": 500, "code": "severError", "message": "Server errror"}
